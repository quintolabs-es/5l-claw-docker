...
### in qnap
docker-compose -f docker-compose-qnap.yml run --rm --no-deps --entrypoint bash openclaw-standalone-cli -lc 'bash skills/backup-state-to-drive/scripts/backup-state-to-drive.sh'
```
